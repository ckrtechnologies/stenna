...
- Name: frontend/ai-recommendations.spec.js >> AI Recommendations Flow >> should log in, take the AI questionnaire, and see recommendations
- Location: tests/frontend/ai-recommendations.spec.js:5:3
    ...
    - generic [ref=e6]:
      ...
      - generic [ref=e9]:
        - generic [ref=e10]:
          ...
          - textbox "name@example.com" [ref=e12]: testuser_1787075808402@example.com
        - generic [ref=e13]:
